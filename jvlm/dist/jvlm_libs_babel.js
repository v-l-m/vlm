...
var Verimail = Comfirm.AlphaMail.Verimail = function (l) {
  this.options = {
    url: "http://jsapi.comfirm.se/verify/v1/",
    token: null,
    enforceTld: !0,
    denyTempEmailDomains: !1,
    language: "en",
    richTextMessages: !0,
  ...
  for (key in l) {
    l.hasOwnProperty(key) && (this.options[key] = l[key]);
  }

  this.setLanguage(this.options.language, "en"), this.Service = {}, this.Service.verify = function (l, n) {
    n(Verimail.Status.CorrectSyntax, "It looks OK!");
  };
};
...
Verimail.Status = {
...
}, Verimail.MostCommonEmailDomains = (_Verimail$MostCommonE = {
  "gmail.com": null,
  "msn.com": null,
  "hotmail.com": null,
  "hotmail.co.uk": null,
  ...
  "googlemail.com": null,
  "att.net": null
}, _defineProperty(_Verimail$MostCommonE, "mail.com", null), _defineProperty(_Verimail$MostCommonE, "mac.com", null), _defineProperty(_Verimail$MostCommonE, "rocketmail.com", null), _defineProperty(_Verimail$MostCommonE, "ymail.com", null), _Verimail$MostCommonE), Verimail.MostCommonTlds = {
  com: null,
  org: null,
  edu: null,
  gov: null,
...
}, Verimail.getLevenshteinDistance = function (l, n) {
  try {
    n = !"0"[0];
  } catch (l) {
    n = !0;
  ...
  return function (e, u) {
    if (e == u) return 0;
    if (!e.length || !u.length) return u.length || e.length;
    n && (e = e.split(""), u = u.split(""));

    for (var i, t, a, s = e.length + 1, r = u.length + 1, o = 0, m = 0, c = [[0]]; ++m < r;) {
      c[0][m] = m;
    }

    for (m = 0; ++m < s;) {
      for (a = t = 0, i = e[o], c[m] = [m]; ++t < r;) {
        c[m][t] = l(c[o][t] + 1, c[m][a] + 1, c[o][a] + (i != u[a])), ++a;
      }
...
}(Math.min, !1), Verimail.getClosestString = function (l, n, e, u) {
  e = e || .5;
  var i = Number.MAX_VALUE,
      t = !1;
  if (u = u || Verimail.getLevenshteinDistance, !(l in n)) for (var a in n) {
    var s = u(l, a);
    s < i && s / l.length < e && (i = s, t = a);
  }
  return t;
}, Verimail.getClosestTld = function (l, n, e) {
  return Verimail.getClosestString(l, Verimail.MostCommonTlds, n, e);
}, Verimail.getClosestEmailDomain = function (l, n, e) {
  return Verimail.getClosestString(l, Verimail.MostCommonEmailDomains, n, e);
}, Verimail.testEmailFormat = function (l) {
  return /^([^\x00-\x20\x22\x28\x29\x2c\x2e\x3a-\x3c\x3e\x40\x5b-\x5d\x7f-\xff]+|\x22([^\x0d\x22\x5c\x80-\xff]|\x5c[\x00-\x7f])*\x22)(\x2e([^\x00-\x20\x22\x28\x29\x2c\x2e\x3a-\x3c\x3e\x40\x5b-\x5d\x7f-\xff]+|\x22([^\x0d\x22\x5c\x80-\xff]|\x5c[\x00-\x7f])*\x22))*\x40([^\x00-\x20\x22\x28\x29\x2c\x2e\x3a-\x3c\x3e\x40\x5b-\x5d\x7f-\xff]+|\x5b([^\x0d\x5b-\x5d\x80-\xff]|\x5c[\x00-\x7f])*\x5d)(\x2e([^\x00-\x20\x22\x28\x29\x2c\x2e\x3a-\x3c\x3e\x40\x5b-\x5d\x7f-\xff]+|\x5b([^\x0d\x5b-\x5d\x80-\xff]|\x5c[\x00-\x7f])*\x5d))*$/.test(l);
}, Verimail.prototype.setLanguage = function (l, n) {
  this.options.language = l && l in Verimail.Language ? l : n;
}, Verimail.prototype.getLanguageText = function (l, n) {
  var e = Verimail.Language[this.options.language][l];
  return n && (e = e.replace("%s", n)), this.options.richTextMessages || (e = Verimail.stripHtml(e)), e;
}, Verimail.stripHtml = function (l) {
  if (null != l && l.indexOf("<") != -1) if ("undefined" != typeof document) {
    var n = document.createElement("DIV");
    n.innerHTML = l, l = n.textContent || n.innerText;
  } else l = l.replace(/(<([^>]+)>)/gi, "");
  return l;
}, Verimail.getEmailAddressSegments = function (l) {
  for (var n = "local", e = {
    local: "",
    domain: "",
    tld: ""
    ...
    switch (n) {
      ...
      case "tld":
        "." == i ? (e.domain += "." + e.tld, e.tld = "") : e.tld += i;
    }
  }

  return e.fullDomain = e.domain + "." + e.tld, e;
}, Verimail.prototype.verify = function (l, n) {
  l = (l || "").toLowerCase();
  ...
  var e = null,
      ...
      i = null,
      t = function t(l) {
    return "<span class='correction'>" + l + "</span>";
  };

  if (!l || 0 == l.length || l.replace && 0 == l.replace(/(?:(?:^|\n)\s+|\s+(?:$|\n))/g, "").replace(/\s+/g, " ").length) e = Verimail.Status.EmptyError, u = this.getLanguageText("empty");else if (Verimail.testEmailFormat(l)) {
    var a = Verimail.getEmailAddressSegments(l);
    if (this.options.denyTempEmailDomains && a.tld in Verimail.TempEmailDomains && a.domain in Verimail.TempEmailDomains[a.tld]) e = Verimail.Status.BlockedError, u = this.getLanguageText("domainBlocked", a.fullDomain);else if (this.options.enforceTld) if (a.tld) {
      if (!(a.tld in Verimail.IANARegisteredTlds)) {
        e = Verimail.Status.InvalidPart;
        var s = Verimail.getClosestTld(a.tld, 10, this.options.distanceFunction);

        if (s) {
          var r = Verimail.getClosestEmailDomain(a.domain + "." + s, .25, this.options.distanceFunction);
          r ? (i = a.local + "@" + r, u = this.getLanguageText("typo", a.local + "@" + t(r))) : (i = a.local + "@" + a.domain + "." + s, u = this.getLanguageText("typo", a.local + "@" + a.domain + "." + t(s)));
        } else u = this.getLanguageText("invalidTld", a.tld);
      }
    } else e = Verimail.Status.InvalidPart, u = this.getLanguageText("invalidFormat");
  } else e = Verimail.Status.SyntaxError, u = this.getLanguageText("invalidFormat");

  if (null === e || e == Verimail.SyntaxError) {
    var r = Verimail.getClosestEmailDomain(a.domain + "." + a.tld, .3, this.options.distanceFunction);
    r ? (e = Verimail.Status.CorrectSyntax, i = a.local + "@" + r, u = this.getLanguageText("typo", a.local + "@" + t(r))) : (e = Verimail.Status.CorrectSyntax, u = u || this.getLanguageText("success"));
  }

  n(e, u, i);
}, function (l, n, e, u) {
  var i = function i(n, e) {
    this.element = n, this.$element = l(n), this.options = e;
  };
  ...
  i.prototype = {
    ...
    init: function init() {
      var n = this,
          e = this.config = l.extend({}, this.defaults, this.options),
          u = this.instance = new Comfirm.AlphaMail.Verimail(this.config),
          i = function i(t) {
        u.verify(t, function (u, a, s) {
          var r = "error",
              o = e.statusElement ? l(e.statusElement) : n.$element,
              m = u == Comfirm.AlphaMail.Verimail.Status.Pending;

          if (u >= 0 && (r = m ? "pending" : "success"), e.onStatusChange && e.onStatusChange(e, u, a, s), o.removeClass(e.prefixName + "-success").removeClass(e.prefixName + "-error").removeClass(e.prefixName + "-pending").addClass(e.prefixName + "-" + r), n.isPendingStatus = m, n.$element.data("verimail-status", r), e.messageElement) {
            var c = l("<span>" + a + "</span>").addClass(r);

            if (s) {
              var d = l("<a />").attr("href", "#").click(function () {
                return t = s, n.$element.val(s), i(s), !1;
              });
              l("span.suggestion", c).wrap(d);
            }

            l(e.messageElement).html(c);
          }
        });
      };

      return this.$element.val() && this.$element.val().length > 0 && i(this.$element.val()), this.$element.keyup(function (e) {
        var u = l(this).val();
        n.timeoutId && clearTimeout(n.timeoutId), n.isPendingStatus ? n.timeoutId = setTimeout(function () {
          i(u);
        }, 500) : i(u);
      }), this;
    }
  }, i.defaults = i.prototype.defaults, l.fn.verimail = function (l) {
    return this.each(function () {
      new i(this, l).init();
    });
  }, l.fn.getVerimailStatus = function () {
...
(function (A) {
  A.extend(A.fn, {
    pstrength: function pstrength(B) {
      var B = A.extend({
    ...
    SetPwdClass: function SetPwdClass(A, F, C, Class, Pct) {
      var B = "#" + F + "_bar";
      var E = "#" + F + "_text";
    ...
    runPassword: function runPassword(D, F, C) {
    ...
    checkPassword: function checkPassword(C, B) {
      var F = 0;
      var E = B.verdects[0];
...
})(jQuery); //https://github.com/Eonasdan/bootstrap-datetimepicker#bootstrap-3-datetime-picker-v41747
