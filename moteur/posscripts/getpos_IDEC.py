...
for rid in boats.keys() :
    ...
    print "insert into users (idusers,boattype,boatname,username,engaged) values (%d,'boat_bp5','%s','%s',20150919);"%( +-boats[rid]['vlmid'], boats[rid]['vlmboatname'].replace("'","").encode('utf8'),boats[rid]['vlmusername'].encode('utf8'))
