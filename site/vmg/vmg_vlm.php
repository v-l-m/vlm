...
*/			
      ...
      <p align="center"><a href=<?php echo "\""."vmg_vlm.php?lang=fr"."&boattype=".$_REQUEST['boattype']."&boatlat=".$_REQUEST['boatlat']."&boatlong=".$_REQUEST['boatlong']."&wdd=".$_REQUEST['wdd']."&wds=".$_REQUEST['wds']."&wp1lat=".$_REQUEST['wp1lat']."&wp1long=".$_REQUEST['wp1long']."&wp2lat=".$_REQUEST['wp2lat']."&wp2long=".$_REQUEST['wp2long']."\"" ?> ><img src="fr.gif" align="middle" border="0" height="16" width="24" /></a> <a href=<?php echo "\""."vmg_vlm.php?lang=en"."&boattype=".$_REQUEST['boattype']."&boatlat=".$_REQUEST['boatlat']."&boatlong=".$_REQUEST['boatlong']."&wdd=".$_REQUEST['wdd']."&wds=".$_REQUEST['wds']."&wp1lat=".$_REQUEST['wp1lat']."&wp1long=".$_REQUEST['wp1long']."&wp2lat=".$_REQUEST['wp2lat']."&wp2long=".$_REQUEST['wp2long']."\"" ?> ><img src="en.gif" align="middle" border="0" height="16" width="24" /></a></p>
