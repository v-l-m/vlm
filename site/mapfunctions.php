...
// Si un parametre est pass�, c'est le nu�mro de la course, sinon toutes //
//=================================================================//
...
//-----------------------------------------------------------------//
//               Retourne les coordonn�es de la carte              //
...
function coordCarte($lat_bat, $long_bat, $unite, $HauteurCartePixel, $LargeurCartePixel)
//function CoordCarte () //($lat_bat, $long_bat, $unite, $HauteurCartePixel, $LargeurCartePixel)
    // $unite : unite de carte,  pour le zoom plus le chiffre est �lev� plus le zoom est puissant
    ...
    // $LargeurCartePixel : largeur de la carte en pixel
        ...
        // $lat_bat et $long_bat sont les coordonn�es du point milieu de la carte
        // ce qui permettra par la suite de centrer la carte sur un point quelconque grace � des boutons de d�placement
{
/*
...
*/
    ...
    // pour la longitude � gauche de la carte avec gestion de l'antimeridien
    ...
    // pour la longitude � droite de la carte avec gestion de l'antimeridien
