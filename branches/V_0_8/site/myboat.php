...
<div id="simple">
    ...
    />
        ...
        if ( $usersObj->users->engaged == 81103 ) {
             printf ( "Portimao Leg 3:<BR>* Navigation interdite au sud de 45&deg;S entre les longitudes de 160&deg;W et 100&deg;W. Penalit&eacute; importante en cas d'infraction &agrave; cette r&egrave;gle.<BR>* A Yacht shall not pass to the South of 45&deg;S between the longitudes of 160&deg;W and 100&deg;W. A breach of this rule will result in a significant penalty.\n" );
        }
