...
function interditSUD()
{
	...
	mysql -e "select distinct P.idusers from positions P ,users U 
		...
		mysql -e "update users set pilotmode=2,pilotparameter=0,releasetime=$NOW, blocnote='<B>PENALTY : KEEP NORTH OF THE LINE...</B>' where idusers=$idusers;"
...
RACE=81005
valideNORD   -155000     -140000 -47000  2
valideNORD   -120000     -105000 -45000  3
