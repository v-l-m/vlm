...
geotree = gp.GeovoileTree("http://volvooceanrace.geovoile.com/2011/shared/data/leg9.static.hwz", basefilename)
...
geotree = gp.GeovoileTree("http://volvooceanrace.geovoile.com/2011/shared/data/leg9.update.hwz", basefilename+"update")
