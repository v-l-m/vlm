...
geotree = gp.GeovoileTree("http://transatag2r.geovoile.com/2014/data/race/static.hwz", basefilename)
...
geotree = gp.GeovoileTree("http://transatag2r.geovoile.com/2014/data/race/update.hwz?", basefilename+"update")
