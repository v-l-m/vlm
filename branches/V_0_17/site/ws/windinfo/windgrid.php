<?php
    ...
    $timelimit = get_grib_minmax_time();
    if (($timerequest < $timelimit['min']) || ($timerequest > $timelimit['max'])) {
//    if (($timerequest-time() < -MAX_GRIBTIME_HISTORY) || ($timerequest > MAX_GRIBTIME_FUTURE)) {
