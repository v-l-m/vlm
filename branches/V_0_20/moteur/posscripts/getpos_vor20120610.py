...
timezero = 0 #geotree.timezero() #FIXME (10 jun 2012 - 14:00:00 GMT)

boats = geotree.boats()

geotree = gp.GeovoileTree("http://volvooceanrace.geovoile.com/2011/shared/data/leg8.update.hwz", basefilename+"update")
