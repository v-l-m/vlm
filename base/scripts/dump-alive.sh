...
TBNAMES="admin_changelog auto_pilot flags players players_pending playerstousers positions races racespreview races_instructions races_loch races_ranking races_results races_waypoints racesmap updates user_action user_prefs users waypoint_crossing waypoints news racestogroups racesgroups modules_status"
