...
int main (int argc, char **argv)
{
        ...
        switch (next_option)
        {
            ...
            case 'n':
                if (optarg)
                {
                    ...
                    // test si nb_tiles est pair ou impair, uniquement les nombres pair sont accept�s
    ...
    //D�termination des longitudes mini, maxi, et origine image x
    ...
    //D�termination des latitudes mini, maxi, et origine image y
