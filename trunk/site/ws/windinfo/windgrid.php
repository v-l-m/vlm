...
$timeoffset = intval(get_cgi_var('timeoffset', 0));
$timerequest = intval(get_cgi_var('timerequest', time()+$timeoffset));
...
if (($step <= 0.0) || ($timerequest - time() < -1000) || ($timerequest - time() > 2592000)) {
//  invalid_values();
}
